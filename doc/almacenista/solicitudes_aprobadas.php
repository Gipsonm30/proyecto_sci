...
<!-- Main -->
<div id="main">	
<center><h3>Procesar solicitudes</h3></center>
...
<td><a class="butonn small" href="solicitudes_aprobadas.php?id=<?php echo $row['id_solic']?>">
Procesar</a></td>                            
</tr> 	
...
<center>
<input type="radio" id="demo-priority-low" name="demo-priority" onclick="location.href='solicitudes_procesadas.php'">
<label for="demo-priority-low">Nota de entrega</label>		
</center>
