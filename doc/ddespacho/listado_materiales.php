...
<tbody>
<?php         
$query = "SELECT * FROM materiales ORDER BY cant";
...
<input type="radio" id="demo-priority-higth" name="materiales" onclick="location.href='../pdf/imprimir_materiales.php'">
<label for="demo-priority-higth">Imprimir lista de materiales</label>
