...
<tbody>
<?php         
$query = "SELECT * FROM equipo_inf";
$resultado = pg_query($dbconn, $query);    
while($row = pg_fetch_assoc($resultado)) { ?>
<tr>
<td><?php echo $row['cod_inventario']; ?></td>
...
<label for="demo-priority-normal">Inventario repuestos</label>

<input type="radio" id="demo-priority-higth" name="equipo" onclick="location.href='../pdf/imprimir_equipos.php'">
<label for="demo-priority-higth">Imprimir lista de equipos</label>
