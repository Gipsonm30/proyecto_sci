...
<!-- Main -->
<div id="main">		
<center><h3>Historico de solicitudes</h3></center>			
...
<?php	} auditoria:: registro_evento ($id_usuario=$_SESSION['coordinador'],$fecha=date("d/m/Y"),$hora=date("G:i:s"),$host=$_SERVER["SERVER_ADDR"],$tipo="Consulta Solicitudes");?>
