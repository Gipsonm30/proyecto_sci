...
function Header()
{
    ...
    $this->Cell(60);
    // Título
    $this->Cell(60,10,'Listado de repuestos',0,0,'C');
    // Salto de línea
    $this->Ln(15);
...
$query = "SELECT * FROM repuestos ORDER BY serial ";
...
$pdf->Cell(30,5,$row['serial'],1,0,'C',0 );
$pdf->Cell(40,5,$row['descripcion'],1,0,'C',0 );
$pdf->Cell(40,5,$row['marca'],1,0,'C',0 );
$pdf->Cell(40,5,$row['fabricante'],1,0,'C',0 );
